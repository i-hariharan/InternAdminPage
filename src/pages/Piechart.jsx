...
function Piechart() {
  const graphType = [
    ...
    {
      id: 4,
      Name: "Internship analysis",
      graphValue: [
        { id: 1, name: "Internship", value: "30%" },
  ...
  return (
    <div className="flex flex-row justify-center items-center min-h-full  w-full bg-[#FAF2BE] mx-auto">
      <div className="grid grid-cols-2 space-y-10 justify-center h-full w-full mx-auto pb-16">
        {graphType.map((g) => (
          <div className="flex justify-center items-center bg-white pr-10 pb-5 h-[300px] mt-10 w-[450px] mx-auto rounded-lg"> 
            ...
            <div>
              ...
              >
                {g.graphValue.map((gv) => {
                  return (
                    <li className="text-lg font-bold font-TimesNewRoman pt-3">
                      {gv.name}-{gv.value}
                    </li>
                  );
                })}
